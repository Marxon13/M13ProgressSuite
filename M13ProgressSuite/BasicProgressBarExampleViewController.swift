//
//  BasicProgressBarExampleViewController.swift
//  M13ProgressSuite
//
...
class BasicProgressBarExampleViewController: UIViewController {
    
    @IBOutlet var horizontalProgressView: M13ProgressBar?
    @IBOutlet var verticalProgressView: M13ProgressBar?
    ...
    @IBAction func animateProgress(sender: UIButton) {
        ...
        weak var weakSelf: BasicProgressBarExampleViewController? = self
        delay(1.0) { () -> () in
